			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<!-- Here action value should be same as @WebServlet("/registration") so we use here action="registration" -->
						<!-- As here we are sending login data top the database and server we need to post the data not to respond so w use post method -->
